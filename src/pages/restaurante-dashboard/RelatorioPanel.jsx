...
const statusLabels = (tipoRestaurante) => {
  ...
  return { pending: 'Recebido', confirmed: 'Confirmado', preparing: termos.emPreparo, ready: termos.pronto, motoboy_collecting: 'Motoboy a caminho', out_for_delivery: 'Em Entrega', delivered: 'Entregue', canceled: 'Cancelado' };
};
